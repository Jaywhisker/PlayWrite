...
import os
from components.build_dataset_visualizations.analyze_caption_lengths import analyze_caption_lengths, analyze_caption_lengths_by_class
from components.build_dataset_visualizations.analyze_caption_repetition import analyze_caption_repetition
from components.build_dataset_visualizations.plot_top_words import plot_top_words

# CONFIGURE FILE PATHS
current_dir = os.path.dirname(__file__)
project_root = os.path.abspath(os.path.join(current_dir, '..', '..', '..'))

def build_dataset_visualizations():
