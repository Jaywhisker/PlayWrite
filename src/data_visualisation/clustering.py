...
if __name__ == "__main__":
    ...
    print("Input data read successfully, starting embedding")
    ...
    print("Input data embedded successfully, starting clustering")

    #blip k-means & hdbscan
